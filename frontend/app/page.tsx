...
const LAST_VERIFIED_PASSING_TEST_COUNT = 622;
...
export default function Home() {
  ...
  const coverageRows = (["dense", "hybrid", "hybrid_reranker", "always_agentic", "adaptive"] as PipelineKey[]).map(
  ...
  return (
    <main>
      <Hero
        agenticQuality={holdout.combined_quality_mean.always_agentic ?? 0}
        adaptiveQuality={holdout.combined_quality_mean.adaptive ?? 0}
        retentionPct={holdout.adaptive_quality_retention_pct_vs_always_agentic}
      />
      <TableOfContents />
      <BusinessProblem />
      <Architecture />
      ...
      <FinalHoldoutResults
        agenticQuality={holdout.combined_quality_mean.always_agentic ?? 0}
        adaptiveQuality={holdout.combined_quality_mean.adaptive ?? 0}
        agenticCoverage={holdout.evidence_coverage_mean.always_agentic ?? 0}
        adaptiveCoverage={holdout.evidence_coverage_mean.adaptive ?? 0}
